...
export const PROJECTS: IProject[] = [
  ...
  {
    name: "Neurons",
    image: "/projects/neurons.png",
    blurImage: "/projects/blur/neurons-blur.png",
    description: "A human management platform",
    gradient: ["#153BB9", "#0E2C8B"],
    url: "https://neurons.dbrain.com.co/",
    tech: ["node", "react", "javascript"],
  },
  {
    name: "My Boletin",
    image: "/projects/myboletin.png",
    blurImage: "/projects/blur/myboletin-blur.png",
    description: "A school management system.",
    gradient: ["#15ac9c", "#A1DDD7"],
    url: "https://app.myboletin.site",
    tech: ["node", "react", "typescript", "postgresql", "nestjs"],
  },
  {
    name: "Knack-Nest Library",
    image: "/projects/knack-nest.png",
    blurImage: "/projects/blur/knack-nest-blur.png",
    description: "Library that integrate knack databases with nest workflow.",
    gradient: ["#b65fc7", "#e3244b"],
    url: "https://www.npmjs.com/package/knack-nest",
    tech: ["npm", "typescript", "nestjs", "knack"],
  },
];
